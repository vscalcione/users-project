...
public class EmployeeController extends CrudController<EmployeeDto, Integer, EmployeeService> {
    ...
    public String showAssignActivity(@PathVariable("id") Integer idEmployee, Model model) {
        ...
        model.addAttribute("employeesActivityList", activityService.employeeActivitiesList(idEmployee));
    ...
    public String saveAssignActivity(@PathVariable("id") Integer idEmployee, @RequestParam(value="idActivity", required=true) String idActivity, Model model) {
    ...
    public String removeActivity(@PathVariable("idEmployee") Integer idEmployee, @RequestParam(value="idActivity", required=true) String idActivity, Model model) {
