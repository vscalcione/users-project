package it.intersistemi.springframework.todo.controller;
...
public class EmployeeController extends CrudController<DipendenteDto, Integer, DipendenteService> {

	@Autowired
	private AttivitaService attivitaService;

	@Autowired
	public EmployeeController(DipendenteService service) {
		super(service);
	}
